...
## Corpus Check
- 250 files · ~187,830 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2398 nodes · 2739 edges · 240 communities (193 shown, 47 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 30 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `09924d0e`
...
5. `useToasts()` - 14 edges
6. `Informe Semanal - Armador manual` - 14 edges
7. `4. DESIGN ENGINEERING DIRECTIVES (Bias Correction)` - 12 edges
8. `jspdf` - 11 edges
9. `Directive Best Practices` - 11 edges
10. `Script Setup & Macros` - 11 edges
...
- `useReportePagosPDF()` --references--> `jspdf`  [EXTRACTED]
  src/composables/useReportePagosPDF.js → package.json
...
## Communities (240 total, 47 thin omitted)
...
Cohesion: 0.05
Nodes (28): autoSaveMessage, autoSaveStatus, builder, editingIndex, informe, isDeletingDraft, isSaving, isSearching (+20 more)
...
Cohesion: 0.08
Nodes (19): ./RatingRow.vue, activeTab, currentPdfVersion, deleteConfirmState, deleteCountdown, EditableField, formData, hasIntervention (+11 more)
...
Cohesion: 0.05
Nodes (36): activeKpiFilter, activeKpiLabel, allPendingSurgeries, amountKpiFilterMode, areAllSelected, cargarSinComprobante, currentMonthAmount, error (+28 more)
...
Cohesion: 0.05
Nodes (34): emit, props, showActions, activePhotoIndex, cancelDeletePhoto(), clearDeleteTimer(), confirmDeletePhoto(), deleteCountdown (+26 more)
...
Cohesion: 0.07
Nodes (32): close(), emit, fileUploaderRef, form, handleSave(), isFormValid, isSaving, props (+24 more)
...
Cohesion: 0.08
Nodes (27): closeModal(), emit, estadosQueja, formData, handleSave(), props, emit, filters (+19 more)
...
Cohesion: 0.06
Nodes (34): chartData, chartOptions, countsList, hasData, props, totalVotes, activeChartTab, activePeriod (+26 more)
...
Cohesion: 0.15
Nodes (14): confirming, emit, handleAnular(), isSubmitting, props, { showSuccessToast, showErrorToast }, emit, fileUploader (+6 more)
...
Cohesion: 0.07
Nodes (23): allSelected, copiedEmail, emailList, emit, formatDate(), openMailtoApp(), props, selectedEmails (+15 more)
...
Cohesion: 0.36
Nodes (9): jspdf, copyLinkFromCard(), error, exportarListaPDF(), exportarResumenPacientePDF(), exportarSeleccionPDF(), exportarTrazabilidadPDF(), formatDate() (+1 more)
...
Cohesion: 0.33
Nodes (6): deleteCurrentDraft(), fetchUserDrafts(), handleNewReportClick(), loadDraftData(), startNewCleanReport(), switchDraft()
...
Cohesion: 0.22
Nodes (4): errorMsg, isLoading, logisticaControls, props
...
### Community 228 - "close"
Cohesion: 0.47
Nodes (6): cancelDelete(), cancelEdit(), close(), confirmDelete(), emit, saveChanges()
...
Cohesion: 0.50
Nodes (5): addMovementToList(), cancelEditMovement(), clearSelectedCirugia(), deleteMovimiento(), scheduleAutoSave()

### Community 238 - "saveDraftInternal"
Cohesion: 0.50
Nodes (4): openResumenModal(), saveDraftInternal(), saveDraftManual(), submitInformeFinal()

## Knowledge Gaps
- **1458 isolated node(s):** `name`, `private`, `version`, `type`, `dev` (+1453 more)
