...
## Corpus Check
- 246 files · ~179,217 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2323 nodes · 2634 edges · 231 communities (185 shown, 46 thin omitted)
...
Cohesion: 0.07
Nodes (23): addMovementToList(), builder, clearSelectedCirugia(), informe, isSaving, isSearching, isSending, loading (+15 more)
...
Cohesion: 0.06
Nodes (31): checkDni(), dni, dniError, emit, instrumentador, instrumentadorFound, isCheckingDni, isSaving (+23 more)
...
Cohesion: 0.12
Nodes (10): emailHtmlContainer, informe, loading, movimientos, route, showEmailModal, toast, totalBultos (+2 more)

### Community 72 - "jspdf"
Cohesion: 0.13
Nodes (10): formattedToday, loading, recentInformes, toast, todayCajasCount, todayInforme, todayMovimientos, todayMovimientosCount (+2 more)
...
Cohesion: 0.18
Nodes (7): filteredInformes, filterEstado, filterFechaDesde, filterFechaHasta, informes, loading, toast
...
Cohesion: 0.05
Nodes (29): errorMsg, isLoading, logisticaControls, props, dateTimeFormatter, errorMsg, isLoading, logisticaData (+21 more)
...
Cohesion: 0.33
Nodes (6): confirming, emit, handleAnular(), isSubmitting, props, { showSuccessToast, showErrorToast }
...
Cohesion: 0.33
Nodes (6): changePage(), emit, endItem, props, startItem, totalPages
...
Cohesion: 0.14
Nodes (10): Always Provide Stable Keys, Do Not Use `mode` on TransitionGroup, Stagger List Animations with Data Attributes, Task List, TransitionGroup Component Best Practices, Use TransitionGroup for Lists, Avoid Expensive Operations in Updated Hook, Prefer Computed Properties for Derived Data (+2 more)
