...
<template>
  <div class="flex h-screen bg-slate-100/80 dark:bg-slate-950 font-sans text-slate-900 dark:text-slate-100 overflow-hidden">
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
      ...
      <header class="bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800 h-10 flex items-center justify-between px-3 shrink-0 z-20 select-none">
        ...
        <div class="flex items-center gap-2">
          ...
          <button 
            @click="toggleSidebar" 
            class="p-1.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 md:hidden focus:outline-none transition-colors active:scale-95 cursor-pointer flex items-center justify-center shrink-0"
