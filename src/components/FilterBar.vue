...
<template>
  <div class="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-5 rounded-2xl shadow-sm mb-6 space-y-5">
    
    <!-- FILA 1: Filtros Principales y Control de Fechas -->
    <div class="flex flex-wrap items-end gap-5">
      <div class="flex-grow grid grid-cols-1 sm:grid-cols-3 gap-5">
        <div class="space-y-1.5">
          <label for="paciente" class="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Paciente</label>
        ...
        <div class="space-y-1.5">
          <label for="medico" class="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Médico</label>
          <div class="relative rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-slate-50/50 dark:bg-slate-950/20 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/10 transition-all duration-150">
        ...
        <div class="space-y-1.5">
          <label for="instrumentador" class="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Instrumentador</label>
          <div class="relative rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-slate-50/50 dark:bg-slate-950/20 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/10 transition-all duration-150">
      ...
      <div class="grid grid-cols-2 gap-4 sm:flex sm:gap-3 items-end">
        <div class="relative" ref="dateRangeMenu">
          <label class="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1.5">Fichas Recibidas</label>
          <button @click="isDateRangeMenuOpen = !isDateRangeMenuOpen" class="btn-secondary w-full sm:w-44 flex items-center justify-between shadow-sm">
            <span>{{ selectedRangeLabel }}</span>
            <ChevronDownIcon class="h-4 w-4 text-slate-500 dark:text-slate-400" />
          </button>
        ...
        <div class="space-y-1.5">
          <label for="startDate" class="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Desde</label>
          <div class="relative rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-slate-50/50 dark:bg-slate-950/20 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/10 transition-all duration-150">
        ...
        <div class="space-y-1.5">
          <label for="endDate" class="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Hasta</label>
          <div class="relative rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-slate-50/50 dark:bg-slate-950/20 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/10 transition-all duration-150">
    ...
    <div class="border-t border-slate-100 dark:border-slate-800/80 pt-5">
      <div class="flex flex-wrap items-end gap-5">
        <div class="flex-grow grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
          <div class="space-y-1.5">
            <label for="status" class="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Estado</label>
            <div class="relative rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-slate-50/50 dark:bg-slate-950/20 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/10 transition-all duration-150">
          ...
          <div class="space-y-1.5">
            <label for="puntualidad" class="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Puntualidad ≤</label>
            <div class="relative rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-slate-50/50 dark:bg-slate-950/20 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/10 transition-all duration-150">
          ...
          <div class="space-y-1.5">
            <label for="condiciones" class="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Condiciones ≤</label>
            <div class="relative rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-slate-50/50 dark:bg-slate-950/20 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/10 transition-all duration-150">
          ...
          <div class="space-y-1.5">
            <label for="asesoramiento" class="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Asesoramiento ≤</label>
            <div class="relative rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-slate-50/50 dark:bg-slate-950/20 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/10 transition-all duration-150">
          ...
          <div class="space-y-1.5 col-span-2 sm:col-span-1">
            <label for="general" class="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">General ≤</label>
            <div class="relative rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-slate-50/50 dark:bg-slate-950/20 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/10 transition-all duration-150">
            ...
            <Transition name="fade">
              <div v-if="isExportMenuOpen" class="export-menu border border-slate-100 dark:border-slate-700/80">
                <button @click="exportAndClose('export-lista')" class="export-menu-item">
                  <ClipboardDocumentListIcon class="h-4.5 w-4.5 text-slate-500" />
                  <span>Exportar Lista</span>
                </button>
                <button @click="exportAndClose('export-trazabilidad')" class="export-menu-item">
                  <DocumentChartBarIcon class="h-4.5 w-4.5 text-slate-500" />
...
<style scoped>
.form-input-premium {
  @apply w-full px-3 py-2 bg-transparent border-none text-slate-800 dark:text-slate-100 text-sm focus:outline-none focus:ring-0;
}

.form-input-select {
  @apply w-full px-3 py-2 bg-transparent border-none text-slate-800 dark:text-slate-100 text-sm focus:outline-none focus:ring-0 cursor-pointer;
}

.btn-secondary {
  @apply bg-slate-100 dark:bg-slate-800 border border-slate-200/40 dark:border-slate-700/60 text-slate-700 dark:text-slate-200 font-semibold py-2.5 px-4 rounded-xl text-sm shadow-sm;
  @apply hover:bg-slate-200 dark:hover:bg-slate-700;
  @apply active:scale-95 transition-all duration-150 cursor-pointer;
}

.btn-clear-large {
  @apply bg-slate-100 dark:bg-slate-800 border border-slate-200/40 dark:border-slate-700/60 text-slate-700 dark:text-slate-200 font-bold py-2.5 px-4 rounded-xl text-sm shadow-sm;
  @apply hover:bg-slate-200 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white;
  @apply active:scale-95 transition-all duration-150 cursor-pointer;
}

.btn-primary-large {
  @apply bg-indigo-600 text-white font-bold py-2.5 px-5 rounded-xl text-sm shadow-sm transition-all duration-150;
...
.btn-export-premium {
  @apply bg-emerald-600 text-white font-bold p-2.5 rounded-xl shadow-sm hover:bg-emerald-700 disabled:opacity-50 disabled:cursor-wait;
  @apply active:scale-95 transition-all duration-150 cursor-pointer;
}

.export-menu, .date-range-menu {
  @apply absolute right-0 mt-2 w-56 origin-top-right rounded-xl bg-white dark:bg-slate-800 shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none z-10 p-1.5;
}

.export-menu-item, .date-range-menu-item {
  @apply flex items-center gap-3 w-full px-3 py-2.5 text-sm rounded-lg text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700/80 transition-colors cursor-pointer font-medium;
}
